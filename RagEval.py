...
def salvar_avaliacoes(arquivo_csv, avaliacoes):
    ...
    with open(arquivo_csv, 'w', newline='', encoding='utf-8') as f:
        ...
        writer.writerow([
            ...
            "Precision@K", "Recall@K", "MRR", "F1-Score", "Average Precision",
            "Mean Average Precision", "nDCG", "Fallout", "R-Precision", "Hit Rate", "Bpref"
        ])
        for av in avaliacoes:
            writer.writerow([
                ...
                av['metricas']['mean_average_precision'],
                av['metricas']['ndcg'],
                av['metricas']['fallout'],
                av['metricas']['r_precision'],
                av['metricas']['hit_rate'],
                av['metricas']['bpref']
            ])
